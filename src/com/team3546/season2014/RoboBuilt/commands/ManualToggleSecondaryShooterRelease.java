...
/**
 * Manually Toggles the Secondary Shooter Release
 */
public class  ManualToggleSecondaryShooterRelease extends Command {
    ...
    public ManualToggleSecondaryShooterRelease() {
        //Build a profile to describe the usage of this command
        requiredSystems = new RobotSystemsGroup();
        //This command just needs to use the secondary shooter release
    ...
    protected void initialize() {
        ...
        if (executeCommand) {
            //Toggle the position of the secondary shooter release
            Robot.shooter.toggleSecondaryShooterRelease();
        }
    }
